...
The project will set the budget for each system to below $150 CAD. Informally put, I am unemployed.

Afterwards, the next steps would be deploying _f_ into an analog system(s), _f_analog_, and a digital system(s), _f_digital_.
